...
import { KeyOutlined, EyeInvisibleOutlined, EyeOutlined,
  LoadingOutlined,
...
const ResetPasswordForm = ({ password, setPassword, confirmPassword, setConfirmPassword,
  handleSubmit, t, errorText, mainError, loading, success }) => (
    <div className="w-full min-h-screen flex justify-center items-center ">
      <div className="flex justify-center items-center w-1/2 md:w-full">
        <div className="flex flex-col w-full justify-center items-center ">
          <h1 className="text-3xl mb-4 text-center w-[80%] font-500">{t('auth.reset')}</h1>
          {
            mainError.length > 0
            && (
